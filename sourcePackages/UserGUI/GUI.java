...
public class GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnSearch.setText("Search Hashtag");
        ...
        jButton5.setText("Follower Feed");
    ...
    private void btnProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProfileActionPerformed
        if(currentUser ==null){
            ...
            prof.setUser(currentUser,currentUser);
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        ...
        else if(jLabel4.getText().startsWith("Your")){
            if(posts.size()-1 != index){
                currentPost(posts.get(index+1));
                index++;
            }
    ...
    private void btnUploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUploadActionPerformed
        ...
        */
        ...
        if (result == JFileChooser.APPROVE_OPTION)
        {
            ...
            try {
                uploadPreview = new Upload(fileChooser.getSelectedFile(),currentUser);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jLabel4.getText().equals("Main Feed (Guest)")){
            ...
            guestFeed(pData,uData);
        }
        else{
            defaultFeed(pData,currentUser,uData);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if(currentUser == null){
            ...
            jLabel2.setText("Likes: "+(currentPostLikes+1));
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        SearchEngine search = new SearchEngine();
        registeredUser searched = search.searchUser(txtSearch.getText(), uData);
        if(searched != null){
            ProfileScreen prof = new ProfileScreen();
            prof.setUser(searched,currentUser);
            prof.setVisible(true);
            this.dispose();
        }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if(currentUser == null){
            JOptionPane.showConfirmDialog(null, "Guest users do not have followers",
            "Attention", JOptionPane.DEFAULT_OPTION,
            JOptionPane.INFORMATION_MESSAGE, null);
        }
        else{
    ...
    public void defaultFeed(PostDatabase pd, registeredUser user, userDatabase ud){
        index = 0;
        currentUser = user;
        pData = pd;
        uData = ud;
    ...
    public void followerFeed(){
        posts = new ArrayList<Post>();
        for(int i = 0; i < currentUser.getFollowers().size(); i++){
            for(int j = 0; j < pData.size(); j++){
                if(pData.getPost(j).getUser().getUsername().equalsIgnoreCase(
                currentUser.getFollowers().get(i))){
                    posts.add(pData.getPost(j));
                }
            }
        }
        index = 0;
        jLabel4.setText("Your follower's posts");
        currentPost(posts.get(index));
    }
    public void guestFeed(PostDatabase pd, userDatabase ud){
        index = 0;
        currentUser = null;
        pData = pd;
        uData = ud;
    ...
    public void currentPost(Post post){
        ...
        try{
            ImageIcon ii = new ImageIcon(scaleImage(jLabel1.getWidth(),jLabel1.getHeight(),ImageIO.read(new File(fileName.getAbsolutePath()))));
            jLabel1.setIcon(ii);
        }
        catch(Exception e){
            e.printStackTrace();
        ...
        jLabel2.setText("Likes: "+currentPostLikes);
        jTextArea1.setText(post.getUser().getUsername()+": "+post.getComments().get(0));
